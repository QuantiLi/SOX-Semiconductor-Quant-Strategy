...
df_close=pd.read_csv('.venv/SOX_top20_close_cleaned.csv', index_col=0)
df_revenue_with_growth = pd.read_csv('.venv/SOX_top20_revenue_with_growth.csv', parse_dates=['Quarter'])
